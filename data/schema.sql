...
CREATE TABLE IF NOT EXISTS `ingredient` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contains all ingredients' AUTO_INCREMENT=9 ;
...
CREATE TABLE IF NOT EXISTS `recipe` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contains all recipes' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `recipe_ingredient` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Represents the relationship between recipes and ingredient' AUTO_INCREMENT=9 ;
